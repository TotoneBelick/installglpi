...
cd $var2
wget https://github.com/TotoneBelick/installglpi/blob/master/000-default.conf
...
cd $var2
wget https://github.com/TotoneBelick/installglpi/blob/master/default-ssl.conf
...
cd $var2
wget https://github.com/TotoneBelick/installglpi/blob/master/agent.cfg
cp /etc/fusioninventory/agent.cfg /etc/fusioninventory/agent.cfg.old
rm /etc/apache2/sites-available/agent.cfg
cp $var2/agent.cfg /etc/fusioninventory/agent.cfg
rm $var2/agent.cfg
